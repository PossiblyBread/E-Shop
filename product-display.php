...
<html>
    <body>
        ...
        <form action="" method="post" class="product-form" id="productForm">
            <!-- for image -->
            <div class="file-upload">
                <h4>Upload Image</h4>
                <input type="file" name="p_image" class="form-control" accept=".jpeg, .jpg, .png" title="Upload Image" id="p_image" required />
            </div>
            <h4>Basic Info</h4>
            ...
            <a href="Guest.php" class="cancel-button">Cancel</a>
        </form>
    </body>
</html>
<style>
